...
| --------------- | --------- | ------------- |
| 09:55–10:40     | F3        | Entrenamiento |
| 11:05–11:50     | F2        | Entrenamiento |
| **13:30–14:30** | **F1**    | **Libres 1**  |
| 15:00–15:30     | F2        | Clasificación |
| **17:00–18:00**     | **F1**        | **Libres 2**      |
| 18:25–19:15     | F3        | Clasificación |

### Sábado 12

| Hora            | Categoría | Sesión            |
| --------------- | --------- | ----------------- |
| 11:05–11:50     | F3        | Carrera Sprint    |
| **12:30–13:30**     | **F1**        | **Libres 3**          |
| 14:15–15:05     | F2        | Carrera Sprint    |
| **16:00–17:00** | **F1**    | **Clasificación** |

### Domingo 13

| Hora            | Categoría | Sesión              |
| --------------- | --------- | ------------------- |
| 09:45–10:35     | F3        | Carrera             |
| 11:25–12:30     | F2        | Carrera             |
| **13:00–13:30** | **F1**    | **Drivers' Parade** |
| **15:00–17:00**     | **F1**        | **Carrera**             |
...
![[F1_Madrid_positivo_esp_2026.webp]]

Fuente: https://www.madring.com/mapa-servicios
...
## Movimiento dentro del circuito
...
- Ubicación de todos los servicios respecto a nuestra grada

### Norte / Sur

Confirmar las restricciones de movimiento entre MADRING Norte y MADRING Sur.
...
- Recogida
- Uso
- Si es necesaria para entrar
- Si debe llevarse puesta
- Uso para MAD-COINS
- Qué ocurre si se pierde
- Saldo sobrante

>Hasta el 10 de septiembre puedes recoger tu pulsera MADRING, que será tu entrada para el Gran Premio. Solo tienes que acercarte a cualquiera de los centros El Corte Inglés de Castellana, Princesa, Serrano o Preciados con tu código QR y recogerla, en horario de 12:00 a 21:00. Guárdala bien. Nos vemos en MADRING.

## Salida y reentrada

> [!warning]  
> No se puede salir del circuito y volver a entrar durante el mismo día.

Por tanto, una vez dentro hay que contar con pasar el resto del día en el recinto.

Antes de entrar:

- Comprobar que llevamos todo
- Ir al baño
- Revisar batería del móvil
- Llevar agua si está permitido
- Llevar protección solar
- Llevar chubasquero si procede
- Tener MAD-COINS preparadas

## Pagos

### MAD-COINS

Sistema de pago utilizado dentro del circuito.

Pendiente:

- Cómo recargar
- Si se puede recargar antes de llegar
- Cómo consultar saldo
- Si se acepta tarjeta
- Si se acepta efectivo
- Cómo recuperar el saldo sobrante
...
Pendiente de confirmar si existe una tercera dimensión máxima.

### Powerbank

La normativa indica:

**Power banks / baterías portátiles USB: tamaño móvil máximo**
...
- Comprobar dimensiones físicas
- Confirmar que cumple el límite

### Otros
#### Permitido / por confirmar
...
- Maletas
- Trolleys
- Mochilas grandes fuera de las dimensiones permitidas
- Drones
...
- Pancartas políticas / religiosas
- Tiendas
- Mesas de camping
- Sacos
- Sillas
...
|Día|Temperatura|Lluvia|Viento|Notas|
|---|---|---|---|---|
|Viernes 11|||||
|Sábado 12|||||
|Domingo 13|||||

Actualizar durante la semana del GP.

## Horarios del circuito

| Día        | Apertura | Cierre | Llegada prevista |
| ---------- | -------- | ------ | ---------------- |
| Viernes 11 |          |        |                  |
| Sábado 12  |          |        |                  |
| Domingo 13 |          |        |                  |
...
Primera sesión: **11:05 — F3 Sprint**
...
Primera sesión: **09:45 — F3 Carrera**

Salida del alojamiento:  
Llegada a Valdebebas:  
Entrada al circuito:

Salida del circuito después de F1: **17:00**
...
- [ ]  Chubasquero
- [ ]  Cojín de asiento
- [ ]  Botella ≤ 500 ml, si se confirma
- [ ]  Powerbank, si se confirma
- [ ]  Todo lo necesario para pasar el día dentro
...
- [ ]  Frecuencias C2 / C7
- [ ]  Frecuencia C1
- [ ]  Refuerzos especiales del GP
- [ ]  Tiempo Valdebebas → Acceso E
- [ ]  Colas previsibles
- [ ]  Comparativa Metropolitano / Bernabéu
