...
Vamos ahora a ver **cómo sería este diseño utilizando módulos independientes**. Para empezar veremos un ejemplo lo que pretendemos conseguir:

![[Cabecera_módulos.png]]

Para entender este esquema debemos fijarnos en que cada módulo tiene dos conectores superiores y dos inferiores. Uno de los conectores superiores se utiliza para recibir la señal de entrada, el otro es para transmitir esa misma señal al módulo siguiente. Vemos que la antena de FM se conectará al módulo amplificador de esas frecuencias y la señal no continúa, esto es: en la salida de continuación se coloca un terminador (resistencia de 75Ω que evita el rebote de la señal).
