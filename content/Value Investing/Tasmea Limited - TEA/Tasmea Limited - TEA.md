---
title: Tasmea Limited - TEA
date: 2026-05-23
---
<table style="width:75%">
  <tr>
    <th>Bolsa</th>
    <td>ASX (Australian Securities Exchange)</td>
  </tr>
  <tr>
    <th>Ticker</th>
    <td>TEA</td>
...
La estrategia de crecimiento se basa en 2 pilares: crecimiento orgánico y mediante adquisiciones, es decir, no crece exclusivamente de forma inorgánica.

![[TEA_Two_Pillar_Growth.png]]
...
La remuneración consiste en una combinación de un salario fijo y un bonus a corto plazo (de hasta 300.000 dólares australianos en el caso de los directivos con mayor sueldo). El esquema de remuneración se encuentra detallado en las páginas 28-42 del [Informe Anual de 2025](https://cdn-api.markitdigital.com/apiman-gateway/ASX/asx-research/1.0/file/2924-03011723-6A1291953&v=undefined).
...
- **Riesgo asociado a *roll-ups***: La estrategia de crecimiento mediante adquisiciones constituye **uno de los principales riesgos** de Tasmea. El éxito del modelo depende de que la compañía continúe adquiriendo empresas de calidad a valoraciones razonables e integrándolas correctamente. Existe el [riesgo de **sobrepagar** por negocios cuyos beneficios se encuentren en máximos cíclicos](https://x.com/JasonPhill40479/status/2069569919021453551?s=20), especialmente en un [entorno de fuerte competencia por adquirir contratistas industriales privados](https://x.com/RonShamgar/status/2069557942379274497?s=20). Además, [el elevado ritmo de adquisiciones incrementa el riesgo de una due diligence insuficiente, errores de valoración o dificultades de integración](https://x.com/JasonPhill40479/status/2069570205081342449?s=20). Aunque Tasmea mitiga parcialmente estos riesgos mediante una estructura descentralizada, el uso de *earn-outs* (pagos variables al vendedor por objetivos, es decir, condicionados a que la empresa adquirida cumpla con objetivos de beneficios o rendimiento tras la adquisición) y la permanencia de los antiguos propietarios al frente de las empresas adquiridas, una mala asignación de capital o una ralentización de la estrategia de adquisiciones podrían afectar significativamente a su crecimiento y a su valoración.
- **¿Qué ocurre durante un ciclo bajista de las materias primas (*commodities*)?**: Tasmea está diversificada, salvo por su elevada concentración en mineral de hierro (*iron ore*, algo que es intencionado, ya que este sector cuenta con vientos de cola estructurales (_long secular tailwinds_). Aun así,  merece la pena analizar los riesgos que supondría una ciclo bajista de las materias primas para comprender mejor cómo operan estas compañías mineras durante los períodos de debilidad del mercado. Los negocios de materias primas generan ingresos en función de lo que producen; cada vez que paralizan una explotación (*shutdown*) dejan de producir y, por tanto, de obtener ingresos. Incluso durante un ciclo bajista, es mejor mantener la actividad con normalidad. Cada parada (*shutdown*) implica devolver maquinaria alquilada, realizar trabajos de mantenimiento asociados a la misma (*proactive shutdown maintenance*), rescindir contratos de arrendamiento (*leases*) y perder mano de obra cualificada que posteriormente resulta difícil reemplazar (*hard-to-replace*). Volver a poner en marcha estos recursos cuesta tiempo, entre uno y dos años de preparación. Por ello, cuando una empresa decide reabrir una planta, necesita invertir una cantidad considerable de dinero, tiempo y recursos. La mayoría de veces, la opción más sencilla y eficiente es continuar operando con normalidad, y esto es precisamente lo que hacen la mayoría de las compañías.

	![[TEA_FY25_Diversification.png]]

- **Base de clientes de Tasmea**: La compañía se asegura de no estar concentrada en un único cliente, es decir, garantizar que no existe una dependencia excesiva de un cliente. De acuerdo al [*prospectus* presentado para la salida a bolsa en 2024](https://tasmea.com.au/wp-content/uploads/2024/04/Tasmea-Limited-Replacement-Prospectus-28-March-2024.pdf) , trabaja con más de 30 empresas altamente rentables y con elevados márgenes de beneficio. La pérdida (*sutdown*) de uno de sus cliente no tendría un impacto significativo en el negocio. La directiva ha indicado que están diversificando deliberadamente tanto su base de clientes como los sectores en los que opera con el objetivo de estar bien posicionados y preparados para todos los escenarios económicos y de mercado.

	![[TEA_Customer_Base_Prospectus.png]]

- **Oportunidades en ciclos bajistas**: Una parte de la estrategia de dos pilares de Tasmea (*two-pillar growth strategy*) es el crecimiento inorgánico, es decir, mediante adquisiciones. El mejor momento para adquirir compañías suele ser cuando estas atraviesan dificultades y el comprador (*acquirer*) tiene un mayor poder de negociación. En un ciclo bajista, Tasmea podría aprovechar la robustez de sus flujos de caja y de su balance para adquirir empresas de alta calidad a múltiplos baratos. Aunque esto podría traducirse en una caída de la cotización a corto plazo, la empresa está bien posicionada para gestionar estos periodos a largo plazo.
...
- **Competencia**: Las únicas empresas con las que realmente compite Tasmea son otros pequeños proveedores de servicios industriales. El respaldo corporativo del grupo, las relaciones de larga duración con sus clientes y su historial de resultados consistentes le permiten ofrecer un servicio o producto superior al de la mayoría de sus competidores. En cuanto a la competencia por adquirir empresas, es poco probable que sea intensa debido al reducido tamaño de los negocios que Tasmea suele comprar. La mayoría de las firmas de capital riesgo (*private equity*) buscan adquisiciones de mayor envergadura, mientras que muchos competidores más pequeños, normalmente empresas familiares o de propietarios individuales (*mom-and-pop businesses*), no disponen del capital suficiente para competir en este tipo de operaciones. Tasmea se ha posicionado deliberadamente en ese segmento intermedio, lo que explica por qué encuentra relativamente poca competencia a la hora de realizar adquisiciones.
