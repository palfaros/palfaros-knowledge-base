...
- **200 millones de euros** a la **reducción de deuda financiera neta**:
	...
	4. El **[9 de enero de 2026](https://otp.tools.investis.com/clients/uk/zegona/rns/regulatory-story.aspx?cid=1048&newsid=2023418&culture=en-GB&val=639035888276971506)**, Zegona anunció la **refinanciación exitosa de su préstamo Term Loan B** por un importe aproximado de **1.700 millones de euros**, con vencimiento en **julio de 2029**, reduciendo el **coste total de la deuda al 4,35%** (*all-in interest rate*), tras una **disminución del margen de 50 puntos básicos**, desde el 2,75% hasta el 2,25% anual, manteniéndose el resto de condiciones contractuales sustancialmente sin cambios. Como resultado de esta operación, el gasto financiero anualizado del grupo se ha reducido en aproximadamente **80 millones de euros** desde el inicio de la inversión en Vodafone España, pasando de un tipo de interés medio del **7,5% al 5,8%**, lo que refuerza la trayectoria descendente del coste de la deuda y pone de manifiesto el respaldo del mercado crediticio a la estructura financiera de Zegona. Además, tras la recepción de los fondos procedentes de **FiberPass**, el principal pendiente del Term Loan B se reducirá hasta **1.665 millones de euros**.
- **200 millones de euros** a un **programa de recompra de acciones**:
